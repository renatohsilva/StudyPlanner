...
{
    public record UploadMaterialRequest(Guid UserId);
    ...
    public async Task<IActionResult> Upload(Guid examId, [FromForm] Guid userId, IFormFile file, CancellationToken cancellationToken)
    {
